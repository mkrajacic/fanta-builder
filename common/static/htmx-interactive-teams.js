window.onload = (event) => {
    ...
    modals.forEach((modalId) => {
        ...
        htmx.on("htmx:beforeSwap", (e) => {
            if (e.detail.target.id == dialogId && !e.detail.xhr.response || e.detail.target.classList.contains("profile")) {
                md.hide();
                if(e.detail.target.classList.contains("profile")) {
